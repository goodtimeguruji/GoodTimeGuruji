...
const CONFIG = {
  secondNakshatraList: ["Ashwini","Rohini","Mrigashira","Punarvasu","Pushya","Magha","Uttara Phalguni","Hasta","Chitra","Swati","Anuradha","Moola","Uttara Ashadha","Shravan","Dhanishta","Satabhisha","Uttara Bhadrapada","Revati"],
...
export default function runAuspiciousCheckAcrossDatesPumsuvanam(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
