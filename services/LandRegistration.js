...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        "Rohini", "Pushya", "Uttara Phalguni", "Hasta", "Chitra", "Swati",
        "Anuradha", "Revati"
    ];
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
    ...
    const disallowedTithis = ["Pratipada", "Chaturthi", "Shasthi", "Saptami", "Ashtami", "Navami", "Dwadashi", "Chaturdashi", "Purnima"];
...
export default async function runAuspiciousCheckAcrossDatesLandRegistration(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
