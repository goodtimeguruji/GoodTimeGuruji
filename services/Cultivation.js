...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        ...
        "Vishakha", "Anuradha", "Moola",
        "Uttara Ashadha", "Shravan", "Dhanishta",
...
export default async function runAuspiciousCheckAcrossDatesCultivation(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
