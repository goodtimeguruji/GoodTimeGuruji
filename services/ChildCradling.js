...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        "Rohini", "Ardhra", "Pushya", "Uttara Phalguni",
        "Uttara Ashadha", "Shravan", "Dhanishta", "Satabhisha",
        "Uttara Bhadrapada"
    ];
...
export default async function runAuspiciousCheckAcrossDatesChildCradling(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
