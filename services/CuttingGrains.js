...
function getFilteredNakshatra(startItem) {
  ...
  const secondNakshatraList = [
    "Bharani", "Rohini", "Mrigashira",
    "Ardhra", "Pushya", "Magha",
    "Uttara Phalguni", "Hasta",
    "Vishakha", "Anuradha",
    "Uttara Ashadha", "Shravan",
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
  ...
  const disallowedTithis = ["Chaturthi", "Ashtami", "Navami", "Ekadashi", "Dwadashi", "Chaturdashi", "Amavasya"];
...
export default async function runAuspiciousCheckAcrossDatesCuttingGrains(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
