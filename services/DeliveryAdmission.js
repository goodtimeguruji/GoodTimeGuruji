...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        ...
        "Anuradha", "Uttara Ashadha", "Shravan", "Uttara Bhadrapada", "Revati"
    ];
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
    ...
    //Avaoid 6,8,12 lagna as well.
    //Avaoid scopio, aquarius 
...
export default async function runAuspiciousCheckAcrossDatesDeliveryAdmission(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
