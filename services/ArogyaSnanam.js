...
function getFilteredNakshatra(startItem) {
  ...
  const secondNakshatraList = [
    "Ashwini", "Bharani", "Krittika", "Mrigashira",
    "Ardhra", "Pushya", "Purva Phalguni", "Hasta", "Chitra",
    "Vishakha", "Anuradha", "Jyeshtha", "Moola", "Poorva Ashadha",
    "Shravan", "Dhanishta", "Satabhisha",
    "Poorva Bhadrapada"
  ];
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
  ...
  const disallowedwaras = ["Somawara", "Shukrawara", "Shaniwara", "Raviwara"];
...
export default async function runAuspiciousCheckAcrossDatesArogyaSnanam(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
