...
function getFilteredNakshatra(startItem) {
  ...
  const secondNakshatraList = [
        ...
        'Uttara Ashadha', 'Shravan', 'Dhanishta','Satabhisha','Uttara Bhadrapada', 'Revati'
  ];
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
  ...
  const disallowedTithis = ["Pratipada", "Chaturthi", "Shasthi", "Ashtami", "Navami", "Dashami", "Chaturdashi", "Purnima", "Amavasya"];
...
export default async function runAuspiciousCheckAcrossDatesTakingMedicine(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
