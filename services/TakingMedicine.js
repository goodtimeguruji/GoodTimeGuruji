...
const CONFIG = {
  ...
  disallowedTithis:    ["Pratipada","Chaturthi","Shasthi","Ashtami","Navami","Dashami","Chaturdashi","Purnima","Amavasya"],
  timeMode:            "day",  // morning=00-13 | day=00-18 | evening=18-24
  lagnaPlace:          8   // which house must be empty in planetary positions
};

export default function runAuspiciousCheckAcrossDatesTakingMedicine(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
