...
const CONFIG = {
  ...
  timeMode:            "evening",  // morning=00-13 | day=00-18 | evening=18-24
  lagnaPlace:          8   // which house must be empty in planetary positions
};

export default function runAuspiciousCheckAcrossDatesShantimuhurtam(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
