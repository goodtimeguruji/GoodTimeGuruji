...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        ...
        "Punarvasu", "Pushya", "Purva Phalguni", "Hasta", "Chitra", "Swati",
        "Vishakha", "Anuradha", "Moola", "Poorva Ashadha",
...
export default async function runAuspiciousCheckAcrossDatesOilBath(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
