...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        ...
        "Ardhra", "Punarvasu", "Pushya", "Hasta", "Anuradha",
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
    ...
    const disallowedwaras = ["Raviwara", "Somawara", "Mangalawara", "Shaniwara"];
    const disallowedTithis = ["Pratipada", "Chaturthi", "Saptami", "Ashtami", "Navami", "Dashami", "Chaturdashi", "Purnima","Amavasya"];
