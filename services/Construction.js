...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        "Rohini", "Mrigashira",
        "Punarvasu", "Pushya", "Magha", "Uttara Phalguni", "Swati",
        "Anuradha", "Uttara Ashadha", "Shravan", "Satabhisha",
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
    ...
    const disallowedwaras = ["Mangalwara","Shaniwara"];
...
export default async function runAuspiciousCheckAcrossDatesConstruction(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
