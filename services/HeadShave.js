...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        ...
        "Punarvasu", "Pushya", "Uttara Phalguni", "Chitra", "Swati",
        "Uttara Ashadha", "Shravan", "Shatabhisha",
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
    ...
    //Avaid Sukra , Suriya , Angaraka, Sani in 7th place
    const disallowedwaras = [];
    const disallowedTithis = ["Pratipada", "Chaturthi", "Shasthi", "Ashtami", "Navami", "Ekadashi", "Dwadashi", "Chaturdashi", "Purnima","Amavasya"];
...
export default async function runAuspiciousCheckAcrossDatesHeadShave(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
