...
function getFilteredNakshatra(startItem) {
  ...
  const secondNakshatraList = [
    ...
    "Punarvasu", "Pushya", "Uttara Phalguni", "Hasta", "Swati",
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
  // ❌ fixed: removed space in "Chaturdashi"
...
export default async function runAuspiciousCheckAcrossDatesDeivaPrathishta(
  fromDateStr,
  toDateStr,
  userNakshatra,
  userRasi,
