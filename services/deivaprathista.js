...
const CONFIG = {
  secondNakshatraList: ["Ashwini","Rohini","Mrigashira","Punarvasu","Pushya","Uttara Phalguni","Hasta","Swati","Anuradha","Uttara Ashadha","Shravan","Dhanishta","Satabhisha","Uttara Bhadrapada","Revati"],
...
export default function runAuspiciousCheckAcrossDatesdeivaprathista(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
