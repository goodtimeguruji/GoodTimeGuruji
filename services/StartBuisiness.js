...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        "Ashwini", "Pushya", "Uttara Phalguni", "Hasta", "Swati",
        "Moola", "Shravan", "Satabhisha",
...
export default async function runAuspiciousCheckAcrossDatesStartBuisiness(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
