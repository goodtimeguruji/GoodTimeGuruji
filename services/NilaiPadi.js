...
const CONFIG = {
  secondNakshatraList: ["Rohini","Mrigashira","Uttara Phalguni","Chitra","Anuradha","Uttara Ashadha","Uttara Bhadrapada","Revati"],
...
export default function runAuspiciousCheckAcrossDatesNilaiPadi(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
