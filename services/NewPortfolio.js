...
function getFilteredNakshatra(startItem) {
    ...
    const secondNakshatraList = [
        "Rohini", "Pushya", "Uttara Phalguni", "Hasta", "Anuradha",
...
async function getAuspiciousTimeWindow(dateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
    ...
    const disallowedwaras = ["Raviwara", "Mangalawara", "Shaniwara"];
    const disallowedTithis = ["Pratipada", "Chaturthi", "Panchmi", "Ashtami", "Navami", "Dashami", "Dwadashi", "Chaturdashi", "Purnima"];
...
export default async function runAuspiciousCheckAcrossDatesNewPortfolio(fromDateStr, toDateStr, userNakshatra, userRasi, lat, lon, tzone, place) {
